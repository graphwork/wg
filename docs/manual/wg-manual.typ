...
#table(
  ...
  [*evaluation source*], [A freeform string tag identifying score origin. Receipt-backed Pi scoring uses `"llm:terminal-observation"`; external conventions include `"outcome:<metric>"`, `"ci:<suite>"`, and `"vx:<peer-id>"`.],
  ...
  [*meta-task*], [A graph task created for explicit autonomous work. Historical assignment/evaluation satellites remain load-only; scored evaluation is not a graph task.],
