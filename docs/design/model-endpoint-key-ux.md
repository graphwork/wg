...
| `config.toml` `model_registry` | `ModelRegistryEntry` | Built-in + user short IDs with cost/tier data (haiku→claude-haiku-4-5) | Mature, used by cost tracking |
...
$ wg model add claude-via-openrouter --provider openrouter \
    --model-id anthropic/claude-sonnet-4-6 --endpoint openrouter --tier standard
Added registry entry: claude-via-openrouter
  claude-via-openrouter / openrouter / anthropic/claude-sonnet-4-6 (tier: standard)
```
...
│  ─────────────────────────────────────────────────────────│
│  haiku        anthropic    claude-haiku-4-5-202…   fast   │
│  sonnet       anthropic    claude-sonnet-4-2025…   std    │
│  opus         anthropic    claude-opus-4-6         prem   │
...
Coordinator: Setting up OpenRouter...
  ...
  ✓ Added model 'claude-sonnet' (anthropic/claude-sonnet-4-6 via openrouter)
...
? Select default model:
  > anthropic/claude-sonnet-4-6 ($3.00/$15.00 per MTok)
    anthropic/claude-opus-4-6 ($15.00/$75.00 per MTok)
