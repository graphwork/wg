...
```toml
[native_executor]
# Anthropic API (used for bare model names like "claude-sonnet-4-5-20250514")
...
wg config --model claude-sonnet-4-5-20250514
...
wg add "Implement feature X" --model claude-sonnet-4-5-20250514
