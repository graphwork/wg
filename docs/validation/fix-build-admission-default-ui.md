...
- `tests/smoke/scenarios/build_admission_inherits_worker_slots.sh` — **PASS**: inherited/explicit hot reloads enforce exact-once admission; generators, remediation, and stopped status pass.
